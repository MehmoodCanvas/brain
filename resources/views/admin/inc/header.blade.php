...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#soncharts-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-sliders"></i><span>CMS</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="soncharts-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          {{-- <li>
